...
### What you can do?
# You can change the turns that you want to give the player
# You can change the list containing Secret word list
...
def hangman_game():
    ...
    print("\nWelcome to Hangman Game created by Hari")
    ...
    turns = 10                                  #Change the turns that you want to give the player
